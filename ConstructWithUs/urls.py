...
path(
    "quotation/<int:quotation_id>/regenerate/",
    views.regenerate_quotation_bill,
    name="regenerate_quotation_bill"
),
...
path(
    "agency/order/<int:order_id>/delivered/",
    views.agency_mark_delivered,
    name="agency_mark_delivered"
),
...
path(
    "engineer-order-bill/<int:order_id>/",
    views.eng_order_bill,
    name="eng_order_bill"
),
...
path(
"site/<int:site_id>/request-quotation/",
